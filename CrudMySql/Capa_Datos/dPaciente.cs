...
namespace Capa_Datos
{
    ...
    {
        SqlConnection cn = new SqlConnection(ConfigurationManager.ConnectionStrings["ConexionDB"].ConnectionString);
    
        public DataTable r_ListarPacientes()
        {
        ...
        public string r_MantenimientoPacientes(Paciente obj, string accion)
        {
            SqlCommand cmd = new SqlCommand("MantenimientoPaciente", cn);
            ...
            switch (accion)
            {
                case "1": Mensaje = "Paciente Registrado"; break;
                case "2": Mensaje = "Paciente Editado"; break;
                case "3": Mensaje = "Paciente Eliminado"; break;
            }

            return Mensaje;
        }

        public int r_ValidacionPaciente(Paciente obj)
        {
        ...
        public int r_ValidacionAdmin(Paciente obj)
        {
            SqlCommand cmd = new SqlCommand("logearse", cn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@DNI", obj.DNI);
